...
// Backwards-compatible initialization when the project's shared sequelize is already available at require time
try {
  const db = require('../src/utils/database');
  if (db && db.sequelize) {
    const models = initModel(db.sequelize);
    module.exports = models;
    module.exports.initModel = initModel;
  }
} catch (e) {
  // noop — allow callers to call initModel explicitly
}
